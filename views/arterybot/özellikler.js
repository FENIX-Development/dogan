...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Artery - Bir Bottan Daha Fazlası!</title>
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="navbar-header">
                                        ...
                                        <a class="navbar-brand" href="index.html">
                                            <img sizes="5" src="assets/images/logo.png"/>
                                        </a>
                                    </div>
                                    ...
                                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                        <ul class="nav navbar-nav navbar-right">
                                            ...
                                            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true">Özellikler!</a>
                                                <ul class="dropdown-menu">
                                                    <li><a href="özellikler.html">Özellikler Sayfa 1</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="botdurum.html">Bot Anlık Durum!</a></li>
                                        </ul>    
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="signle_service_left">
                                            <img src="assets/images/starboard.jpg" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-sm-5 col-sm-push-1">
                                        <div class="single_service">
                                            ...
                                            <p>Bu Sistemde Beğenilen Mesaja Emoji Verilerek Onun Ayarladığınız Kanala Gönderilmesi Sağlanır!</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="copyright_text text-center">
                                <p class=" wow fadeInRight" data-wow-duration="1s">Site Tasarımı;<i class="fa fa-heart"></i> by <a target="_blank" href="https://discord.gg/zXV6rJz">Except</a>2020. Tüm Hakları Saklıdır!</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Artery - Bir Bottan Daha Fazlası!</title>
        <meta name="description" content="">
        <meta property="og:image"  href="assets/images/logo.png"/>
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="apple-touch-icon" href="apple-touch-icon.png">
                        ...
                        <div class="main_home_slider text-center">
                            ...
                            <div class="single_home_slider">
                                ...
                                <div class="main_home wow fadeInUp" data-wow-duration="700ms"> 
                                    ...
                                    <p class="subtitle">Artery Bot<br />
                                         Bir Bottan Daha Fazlası!</p>
                                    <div class="home_btn">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-5 col-sm-push-1">
                                        <div class="single_service">
                                            <h3>♥♥♥</h3>
                                            <div class="separator2"></div>
                                            <p>Asıl Amacımız Sizlere Daha İyi Bir Deneyim Sunmak İçin Artery Botumuzla Uğraşmak :)</p>

                                            <a href="hakkımızda.html" class="btn btn-default">Daha Fazla Bilgi Edinin!</a>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- End of single service area -->
                                ...
                                <div class="contact_contant">
                                    <div class="col-sm-6 col-xs-12">
                                        <div class="single_message_right_info whitetext">
                                            <ul>
                                               <li><i class="fa fa-envelope-o"></i> <span>arterydestek@gmail.com</span></li>
                                            </ul>
